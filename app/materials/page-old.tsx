  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] text-neutral-900">
      ...
      <div className="min-h-screen md:pl-[72px]">
        ...
        <main className="mx-auto w-full max-w-[1500px] px-3 pb-28 pt-3 sm:px-6 sm:pb-12 sm:pt-5 lg:px-8">
          {/* Hero */}
          <section className="mb-5">
            <div className="relative overflow-hidden rounded-[26px] border border-neutral-800 bg-neutral-950 p-5 text-white shadow-[0_18px_50px_rgba(15,23,42,0.12)] sm:p-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="pointer-events-none absolute -right-16 -top-20 h-48 w-48 rounded-full bg-white/[0.06] blur-2xl" />
              <div className="relative z-10">
                <div className="mb-3 flex items-center gap-2">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-neutral-900 shadow-sm">
                    <BookOpen
                      size={18}
                      strokeWidth={1.8}
                    />
                  ...
                  <span className="rounded-full border border-white/10 bg-white/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-white/70 backdrop-blur">
                ...
                <h1 className="max-w-[720px] text-2xl font-bold tracking-[-0.04em] text-white sm:text-3xl">
                  {currentFolder
                    ? getFolderName(
                        currentFolder,
                        language,
                ...
                <p className="mt-2 max-w-[680px] text-sm leading-5 text-white/60">
                  {currentFolder
              ...
              <div className="relative z-10 grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
                <button
                  ...
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/10 px-3 text-xs font-semibold text-white transition active:scale-[0.98] hover:bg-white/15 sm:px-3.5 sm:text-sm"
                >
                  <Folder
                    size={16}
                    strokeWidth={1.8}
                ...
                <button
                  ...
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-red-400/20 bg-red-500/10 px-3 text-xs font-semibold text-red-200 transition active:scale-[0.98] hover:bg-red-500/15 disabled:cursor-not-allowed disabled:opacity-30 sm:px-3.5 sm:text-sm"
                >
                  <Trash2
                    size={16}
                    strokeWidth={1.8}
                ...
                <button
                  ...
                  className="col-span-2 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-white px-3.5 text-sm font-bold text-neutral-950 transition active:scale-[0.98] hover:bg-neutral-100 sm:col-span-1"
                >
                  <Plus
                    size={16}
                    strokeWidth={2}
          ...
          {/* Toolbar */}
          <section className="sticky top-0 z-30 -mx-3 mb-3 flex flex-col gap-2 border-b border-neutral-200/80 bg-[#f3f4f6]/95 px-3 py-2 backdrop-blur-xl sm:static sm:mx-0 sm:mb-4 sm:flex-row sm:items-center sm:justify-between sm:border-0 sm:bg-transparent sm:px-0 sm:py-0">
            <div className="relative w-full sm:max-w-md">
              ...
              <input
                ...
                className="h-12 w-full rounded-2xl border border-neutral-200 bg-white pl-10 pr-4 text-sm outline-none shadow-[0_2px_12px_rgba(15,23,42,0.04)] transition placeholder:text-neutral-400 focus:border-neutral-400 focus:ring-2 focus:ring-neutral-900/5"
              />
            </div>
          ...
          {/* Breadcrumbs */}
          <div className="mb-3 flex items-center gap-1 overflow-x-auto rounded-2xl border border-neutral-200 bg-white px-2 py-1.5 whitespace-nowrap text-sm shadow-sm">
            <button
              type="button"
              onClick={() => {
                setCurrentFolderId(
          ...
          {currentFolder && (
            <button
              ...
              className="mb-3 inline-flex min-h-10 items-center gap-2 rounded-xl bg-white px-3 text-sm font-medium text-neutral-600 shadow-sm transition active:scale-[0.98] hover:text-neutral-900"
            >
              <ArrowLeft
                size={15}
                strokeWidth={1.8}
                    ...
                    (folder) => (
                      ...
                      >
                        <button
                          ...
                          className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl text-left transition active:bg-neutral-50"
                        >
                        ...
                        <div className="flex shrink-0 gap-1">
                          <button
                            ...
                            className="flex h-10 w-10 items-center justify-center rounded-xl text-neutral-400 transition active:scale-95 hover:bg-neutral-100 hover:text-neutral-900"
                          >
                            <Pencil
                              size={
                                14
                          ...
                          <button
                            ...
                            className="flex h-10 w-10 items-center justify-center rounded-xl text-neutral-400 transition active:scale-95 hover:bg-red-50 hover:text-red-600"
                          >
                            <Trash2
                              size={
                                14
      ...
      {/* Folder modal */}
      {folderModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/40 p-0 backdrop-blur-[3px] sm:items-center sm:p-4">
          <div className="w-full max-w-lg max-h-[92vh] overflow-y-auto overflow-hidden rounded-t-[28px] border border-neutral-200 bg-white shadow-2xl sm:rounded-2xl">
